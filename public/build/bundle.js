...
var app = (function () {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$1, 26, 4, 454);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			if (if_block) if_block.c();
    			attr_dev(h1, "class", "header-top svelte-hu8wqm");
    			add_location(h1, file$1, 24, 2, 398);
    			attr_dev(div, "class", "header-container svelte-hu8wqm");
    			add_location(div, file$1, 22, 0, 362);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	let { title } = $$props;
    	let { subtext } = $$props;
    	let { noBackground } = $$props;
    	const writable_props = ["title", "subtext", "noBackground"];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("noBackground" in $$props) $$invalidate(2, noBackground = $$props.noBackground);
    	};

    	$$self.$capture_state = () => ({ title, subtext, noBackground });
    	...
    	return [title, subtext, noBackground];
    }

    class Header extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { title: 0, subtext: 1, noBackground: 2 });
    		...
    		if (/*noBackground*/ ctx[2] === undefined && !("noBackground" in props)) {
    			console.warn("<Header> was created without expected prop 'noBackground'");
    		}
    	}
    ...
    function create_fragment$8(ctx) {
    	...
    	header = new Header({
    			props: {
    				noBackground: true,
    				subtext: "Pressin' Dat Juice since 2019",
    				title: "Lumina Wines"
    			},
    			$$inline: true
    		});
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "class", "svelte-1udr3z");
    			add_location(img0, file$6, 23, 4, 342);
    			add_location(div0, file$6, 24, 4, 384);
    			attr_dev(img1, "alt", "2");
    			if (img1.src !== (img1_src_value = "/photos/2.jpg")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "class", "svelte-1udr3z");
    			add_location(img1, file$6, 25, 4, 458);
    			add_location(div1, file$6, 26, 4, 500);
    			attr_dev(img2, "alt", "1");
    			if (img2.src !== (img2_src_value = "/photos/1.jpg")) attr_dev(img2, "src", img2_src_value);
    			attr_dev(img2, "class", "svelte-1udr3z");
    			add_location(img2, file$6, 27, 4, 577);
    			add_location(div2, file$6, 28, 4, 619);
    			attr_dev(img3, "alt", "2");
    			if (img3.src !== (img3_src_value = "/photos/3.jpg")) attr_dev(img3, "src", img3_src_value);
    			attr_dev(img3, "class", "svelte-1udr3z");
    			add_location(img3, file$6, 29, 4, 677);
    			add_location(div3, file$6, 30, 4, 719);
    			add_location(br0, file$6, 31, 4, 766);
    			add_location(br1, file$6, 32, 4, 776);
    			attr_dev(div4, "class", "photoholder");
    			add_location(div4, file$6, 22, 2, 312);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$f(ctx) {
    	...
    	header = new Header({
    			props: {
    				subtext: "A few of my favorite photos",
    				title: "Gallery"
    			},
    			$$inline: true
    		});
