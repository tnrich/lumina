...
var app = (function () {
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "button is-primary svelte-5vidt");
    			add_location(button, file$4, 89, 2, 2181);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "class", "input is-primary svelte-5vidt");
    			attr_dev(input0, "type", "name");
    			attr_dev(input0, "placeholder", "Name");
    			add_location(input0, file$4, 43, 4, 773);
    			attr_dev(input1, "class", "input is-primary svelte-5vidt");
    			attr_dev(input1, "type", "email");
    			attr_dev(input1, "placeholder", "Email");
    			add_location(input1, file$4, 48, 4, 891);
    			button.disabled = /*sending*/ ctx[2];
    			attr_dev(button, "class", "button is-primary svelte-5vidt");
    			add_location(button, file$4, 53, 4, 1012);
    			attr_dev(div, "class", "bottom-holder svelte-5vidt");
    			add_location(div, file$4, 42, 2, 741);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_default_slot_4(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(37:6) <Route path=\\\"/releases\\\">",
    		ctx
    	});
    ...
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(43:6) <Route path=\\\"/gallery\\\">",
    		ctx
    	});
